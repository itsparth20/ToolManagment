        ...
        public ActionResult Index(HttpPostedFileWrapper CustomerFile, HttpPostedFileWrapper ToolFile, HttpPostedFileWrapper RentalFile)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        CustomerFile.SaveAs(Server.MapPath("~/DBFiles/Customers.txt"));
                        ToolFile.SaveAs(Server.MapPath("~/DBFiles/Tools.txt"));
                        RentalFile.SaveAs(Server.MapPath("~/DBFiles/Rental_data.txt"));
